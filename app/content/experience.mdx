...
- Implemented new screens in Extra's iOS and Android app, built with **React Native** and Expo. Led internal testing sessions and staged rollouts.
- Developed a new funnel prototype using **Next.js** and **React Native Web**, deployed on AWS Serverless. Worked on internal tools built in **React**.
